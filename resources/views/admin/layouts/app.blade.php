...
<html>
  <head>
    ...
    <link href="{!! asset('css/admin/skin-black.css') !!}" rel="stylesheet"/>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{ route('admin.main') }}" class="logo">
          ...
          <span class="logo-lg"><b>Solaris.</b>online</span>
        </a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span>Тесты</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
